...
def joint_probability(people, one_gene, two_genes, have_trait):
    ...
    for person in people:
        ...
        if people[person]["mother"] is None and people[person]["father"] is None:
            ...
            # Probability of inheriting from each parent
            inherit_from_mother = (
            ...
            if genes == 2:
                gene_prob = inherit_from_mother * inherit_from_father
            elif genes == 1:
                gene_prob = (
                    inherit_from_mother * (1 - inherit_from_father) +
                    (1 - inherit_from_mother) * inherit_from_father
                )
            else:
                gene_prob = (1 - inherit_from_mother) * (1 - inherit_from_father)
